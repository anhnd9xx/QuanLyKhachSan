            ...
            <div class="row">
                ...
                <div class="col-lg-5 order-lg-2 order-1">
                    @foreach($product->images as $key => $image)
                        @if($key == 0)
                            <div class="image_selected"><img src="/{{$image['path']}}" alt=""></div>                        @endif
                    @endforeach
                </div>
                        ...
                        <div class="order_info d-flex flex-row">
                            <form action="#">
                                ...
                                <div class="button_container">
                                    <a href="/online/cart/add/{{$product->id}}"><button type="button" class="button cart_button">Add to Cart</button></a>
